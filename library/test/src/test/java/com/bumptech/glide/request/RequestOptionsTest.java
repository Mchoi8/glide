...
public class RequestOptionsTest {
  ...
  ColorDrawable colorD = new ColorDrawable(Color.RED);
  @Spy
  RequestOptions ro1 = new RequestOptions().placeholder(colorD);
  ...
  public void mockTest() {
    //mock tests the placeholder method with ro1 being a spy
    RequestOptions test = Mockito.mock(RequestOptions.class);
    ColorDrawable colorDrawable = new ColorDrawable(Color.RED);
    when(test.placeholder(colorDrawable)).thenReturn(ro1);

    assertThat(test.placeholder(colorDrawable)).isEqualTo(ro1);
  ...
  public void testEqualsHashCode() {
    ...
    new EqualsTester()
        ...
        .addEqualityGroup(package com.bumptech.glide.request;
